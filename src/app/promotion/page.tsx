'use client'
import { Card, CardContent, CssBaseline, Grid, ThemeProvider, createTheme, styled, useMediaQuery } from '@mui/material'
import React, { useEffect, useState } from 'react'
import Footer from '../components/footer';
import { useDispatch } from 'react-redux';
import { fetch_promotion } from '../store/slices/blog_contentSlice';
