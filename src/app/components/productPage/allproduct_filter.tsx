...
import {
  fetchProduct_brandsFilter,
  fetchProduct_TirediameterFilter,
  fetchProduct_TiretypeFilter,
  fetchProduct_TirewidthFilter,
  fetchProduct_TireratioFilter,
  fetchProduct_LubeOil_fluid_typeFilter,
  fetchProduct_LubeOil_engineOil_typesofengineoilFilter,
  fetchProduct_ShockAbsorber_shockuptype,
  fetchProduct_Brake_braketype,
  fetchProduct_Battery_amp,
} from "@/app/store/slices/product_filterSlice";
import {
  Box,
  CssBaseline,
  Grid,
...
export default function Allproduct_filter() {
  ...
  const [
    lubeOil_engineOil_typesofengineoil,
    setLubeOil_engineOil_typesofengineoil,
  ] = useState([]);
  ...
  const [checkedLubeOilBrand, setCheckedLubeOilBrand] = useState<string[]>(
    () => {
      // Check if localStorage is available before using it
      if (typeof window !== "undefined" && window.localStorage) {
        const storedLubeOil_Brand = localStorage.getItem(
          "checkedLubeOil_Brand"
        );
  ...
  const [checkedLubeOilFluid_type, setCheckedLubeOilFluid_type] = useState<
    string[]
  >(() => {
    // Check if localStorage is available before using it
    if (typeof window !== "undefined" && window.localStorage) {
      const storedLubeOil_Fluid_type = localStorage.getItem(
        "checkedLubeOil_Fluid_type"
      );
      return storedLubeOil_Fluid_type
        ? JSON.parse(storedLubeOil_Fluid_type)
        : [];
    } else {
      return [];
    }
  ...
  const [
    checkedLubeOil_engineOil_typesofengineoil,
    setcheckedLubeOil_engineOil_typesofengineoil,
  ] = useState<string[]>(() => {
    // Check if localStorage is available before using it
    if (typeof window !== "undefined" && window.localStorage) {
      const storedLubeOil_engineOil_typesofengineoil = localStorage.getItem(
        "checkedLubeOil_engineOil_Typesofengineoil"
      );
      return storedLubeOil_engineOil_typesofengineoil
        ? JSON.parse(storedLubeOil_engineOil_typesofengineoil)
        : [];
    } else {
      return [];
    }
  ...
  const [checkedShockAbsorberBrands, setcheckedShockAbsorberBrands] = useState<
    string[]
  >(() => {
    // Check if localStorage is available before using it
    if (typeof window !== "undefined" && window.localStorage) {
      const storedShockAbsorberBrands = localStorage.getItem(
        "checkedShockAbsorberBrands"
      );
      return storedShockAbsorberBrands
        ? JSON.parse(storedShockAbsorberBrands)
        : [];
    } else {
      return [];
    }
  ...
  const [checkedShockAbsorberShockuptype, setcheckedShockAbsorberShockuptype] =
    useState<string[]>(() => {
      // Check if localStorage is available before using it
      if (typeof window !== "undefined" && window.localStorage) {
        const storedShockAbsorberShockuptype = localStorage.getItem(
          "checkedShockAbsorberShockuptype"
        );
        return storedShockAbsorberShockuptype
          ? JSON.parse(storedShockAbsorberShockuptype)
          : [];
      } else {
        return [];
      }
  ...
  const [checkedBrakeBraketype, setcheckedBrakeBraketype] = useState<string[]>(
    () => {
      // Check if localStorage is available before using it
      if (typeof window !== "undefined" && window.localStorage) {
        const storedBrakeBraketype = localStorage.getItem(
          "checkedBrakeBraketype"
        );
  ...
  const [checkedBatteryBrands, setcheckedBatteryBrands] = useState<string[]>(
    () => {
      // Check if localStorage is available before using it
      if (typeof window !== "undefined" && window.localStorage) {
        const storedBatteryBrands = localStorage.getItem(
          "checkedBatteryBrands"
        );
  ...
  const [checkedOtherproduct_brands, setCheckedOtherproduct_brands] = useState<
    string[]
  >(() => {
    // Check if localStorage is available before using it
    if (typeof window !== "undefined" && window.localStorage) {
      const storedOtherproduct_brands = localStorage.getItem(
        "checkedOtherproductBrands"
      );
      return storedOtherproduct_brands
        ? JSON.parse(storedOtherproduct_brands)
        : [];
    } else {
      return [];
    }
  ...
  const [subTires_diameter_fIlter, setSubTires_diameter_filter] =
    useState(false);
  ...
  const [subLubeOil_fluid_type_fIlter, setSubLubeOil_fluid_type_filter] =
    useState(false);
  const [
    subLubeOil_engineOil_typesofengineoil_fIlter,
    setSubLubeOil_engineOil_typesofengineoil_filter,
  ] = useState(false);

  const [subShockAbsorber_brand_fIlter, setSubShockAbsorber_brand_fIlter] =
    useState(false);
  const [
    subShockAbsorber_shockuptype_fIlter,
    setsubShockAbsorber_shockuptype_fIlter,
  ] = useState(false);

  const [subBrake_brand_fIlter, setSubBrake_brand_fIlter] = useState(false);
  const [subBrake_braketype_fIlter, setSubBrake_braketype_fIlter] =
    useState(false);
  ...
  const [subOtherproduct_brands, setSubOtherproduct_brands_fIlter] =
    useState(false);

  const handleChangeChkTypes = async (
  ...
  const handleChangeChkTireBrands = async (
    event: React.ChangeEvent<HTMLInputElement>,
    ...
    if (isChecked) {
      ...
      setCheckedTireBrands((prevCheckedTireBrands) =>
        prevCheckedTireBrands.filter((name) => name !== tire_brand_name)
      );
    }
  };

  const handleChangeChkTireDiameter = async (
    event: React.ChangeEvent<HTMLInputElement>,
    tire_diameter_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setCheckedTireDiameter((prevCheckedTireDiameter) =>
        prevCheckedTireDiameter.filter((name) => name !== tire_diameter_name)
      );
    }
  };

  const handleChangeChkTireWidth = async (
    event: React.ChangeEvent<HTMLInputElement>,
    tire_width_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setCheckedTireWidth((prevCheckedTireWidth) =>
        prevCheckedTireWidth.filter((name) => name !== tire_width_name)
      );
    }
  };

  const handleChangeChkTireRatio = async (
    event: React.ChangeEvent<HTMLInputElement>,
    tire_ratio_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setCheckedTireRatio((prevCheckedTireRatio) =>
        prevCheckedTireRatio.filter((name) => name !== tire_ratio_name)
      );
    }
  };

  const handleChangeChkLubeOil_Brand = async (
    event: React.ChangeEvent<HTMLInputElement>,
    lubeOil_brand_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setCheckedLubeOilBrand((prevCheckedLubeOil_Brand) =>
        prevCheckedLubeOil_Brand.filter((name) => name !== lubeOil_brand_name)
      );
    }
  };

  const handleChangeChkLubeOil_Fluid_type = async (
    event: React.ChangeEvent<HTMLInputElement>,
    lubeOil_fluid_type_name: string
  ) => {
    const isChecked = event.target.checked;

    if (isChecked) {
      setCheckedLubeOilFluid_type([
        ...checkedLubeOilFluid_type,
        lubeOil_fluid_type_name,
      ]);
    } else {
      setCheckedLubeOilFluid_type((prevCheckedEngineOil_Fluid_type: any[]) =>
        prevCheckedEngineOil_Fluid_type.filter(
          (name) => name !== lubeOil_fluid_type_name
        )
      );
    }
  };

  const handleChangeChkLubeOil_engineOil_typesofengineoil = async (
    event: React.ChangeEvent<HTMLInputElement>,
    lubeOil_engineOil_typesofengineoil_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      setcheckedLubeOil_engineOil_typesofengineoil([
        ...checkedLubeOil_engineOil_typesofengineoil,
        lubeOil_engineOil_typesofengineoil_name,
      ]);
    } else {
      setcheckedLubeOil_engineOil_typesofengineoil(
        (prevCheckedEngineOil_engineOil_typesofengineoil: any[]) =>
          prevCheckedEngineOil_engineOil_typesofengineoil.filter(
            (name) => name !== lubeOil_engineOil_typesofengineoil_name
          )
      );
    }
  };

  const handleChangeChkShockAbsorberBrands = async (
    event: React.ChangeEvent<HTMLInputElement>,
    shockAbsorber_brand_name: string
  ) => {
    const isChecked = event.target.checked;

    if (isChecked) {
      setcheckedShockAbsorberBrands([
        ...checkedShockAbsorberBrands,
        shockAbsorber_brand_name,
      ]);
    } else {
      setcheckedShockAbsorberBrands((prevCheckedShockAbsorberBrands) =>
        prevCheckedShockAbsorberBrands.filter(
          (name) => name !== shockAbsorber_brand_name
        )
      );
    }
  };

  const handleChangeChkShockAbsorberShockuptype = async (
    event: React.ChangeEvent<HTMLInputElement>,
    shockAbsorber_shockuptype_name: string
  ) => {
    const isChecked = event.target.checked;

    if (isChecked) {
      setcheckedShockAbsorberShockuptype([
        ...checkedShockAbsorberShockuptype,
        shockAbsorber_shockuptype_name,
      ]);
    } else {
      setcheckedShockAbsorberShockuptype(
        (prevCheckedShockAbsorberShockuptype) =>
          prevCheckedShockAbsorberShockuptype.filter(
            (name) => name !== shockAbsorber_shockuptype_name
          )
      );
    }
  };

  const handleChangeChkBrakeBrands = async (
    event: React.ChangeEvent<HTMLInputElement>,
    brake_brand_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setcheckedBrakeBrands((prevCheckedBrakeBrands) =>
        prevCheckedBrakeBrands.filter((name) => name !== brake_brand_name)
      );
    }
  };

  const handleChangeChkBrakeBraketype = async (
    event: React.ChangeEvent<HTMLInputElement>,
    brake_braketype_name: string
  ) => {
    const isChecked = event.target.checked;

    if (isChecked) {
      setcheckedBrakeBraketype([
        ...checkedBrakeBraketype,
        brake_braketype_name,
      ]);
    } else {
      setcheckedBrakeBraketype((prevCheckedBrakeBraketype) =>
        prevCheckedBrakeBraketype.filter(
          (name) => name !== brake_braketype_name
        )
      );
    }
  };

  const handleChangeChkBatteryBrands = async (
    event: React.ChangeEvent<HTMLInputElement>,
    battery_brand_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setcheckedBatteryBrands((prevCheckedBatteryBrands) =>
        prevCheckedBatteryBrands.filter((name) => name !== battery_brand_name)
      );
    }
  };

  const handleChangeChkBatteryAmp = async (
    event: React.ChangeEvent<HTMLInputElement>,
    battery_amp_name: string
  ) => {
    const isChecked = event.target.checked;
    ...
    if (isChecked) {
      ...
      setcheckedBatteryAmp((prevCheckedBatteryAmp) =>
        prevCheckedBatteryAmp.filter((name) => name !== battery_amp_name)
      );
    }
  };

  const handleChangeChkOtherproduct_brands = async (
    event: React.ChangeEvent<HTMLInputElement>,
    otherproduct_brands_name: string
  ) => {
    const isChecked = event.target.checked;

    if (isChecked) {
      setCheckedOtherproduct_brands([
        ...checkedOtherproduct_brands,
        otherproduct_brands_name,
      ]);
    } else {
      setCheckedOtherproduct_brands((prevCheckedOtherproduct_brands) =>
        prevCheckedOtherproduct_brands.filter(
          (name) => name !== otherproduct_brands_name
        )
      );
    }
  };
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined" && window.localStorage) {
      ...
      localStorage.setItem(
        "checkedTireBrands",
        JSON.stringify(checkedTireBrands)
      );
      localStorage.setItem(
        "checkedTireDiameter",
        JSON.stringify(checkedTireDiameter)
      );
      localStorage.setItem(
        "checkedTireWidth",
        JSON.stringify(checkedTireWidth)
      );
      localStorage.setItem(
        "checkedTireRatio",
        JSON.stringify(checkedTireRatio)
      );

      localStorage.setItem(
        "checkedLubeOil_Brand",
        JSON.stringify(checkedLubeOilBrand)
      );
      localStorage.setItem(
        "checkedLubeOil_Fluid_type",
        JSON.stringify(checkedLubeOilFluid_type)
      );
      localStorage.setItem(
        "checkedLubeOil_engineOil_Typesofengineoil",
        JSON.stringify(checkedLubeOil_engineOil_typesofengineoil)
      );

      localStorage.setItem(
        "checkedShockAbsorberBrands",
        JSON.stringify(checkedShockAbsorberBrands)
      );
      localStorage.setItem(
        "checkedShockAbsorberShockuptype",
        JSON.stringify(checkedShockAbsorberShockuptype)
      );

      localStorage.setItem(
        "checkedBrakeBrands",
        JSON.stringify(checkedBrakeBrands)
      );
      localStorage.setItem(
        "checkedBrakeBraketype",
        JSON.stringify(checkedBrakeBraketype)
      );

      localStorage.setItem(
        "checkedBatteryBrands",
        JSON.stringify(checkedBatteryBrands)
      );
      localStorage.setItem(
        "checkedBatteryAmp",
        JSON.stringify(checkedBatteryAmp)
      );

      localStorage.setItem(
        "checkedOtherproductBrands",
        JSON.stringify(checkedOtherproduct_brands)
      );
    }
  ...
  useEffect(() => {
    ...
    dispatch(fetchProduct_LubeOil_engineOil_typesofengineoilFilter()).then(
      async (res: any) => {
        const response = await res.payload.data;
        setLubeOil_engineOil_typesofengineoil(response);
      }
    );
    dispatch(fetchProduct_brandsFilter("shock_absorber")).then(
      async (res: any) => {
        const response = await res.payload.data;
        setShockAbsorber_Brand(response);
      }
    );
    dispatch(fetchProduct_ShockAbsorber_shockuptype()).then(
      async (res: any) => {
        const response = await res.payload.data;
    ...
    dispatch(fetchProduct_brandsFilter("other_product")).then(
      async (res: any) => {
        const response = await res.payload.data;
            ...
            <Grid item xs={12} sx={{ m: 2 }}>
              ...
              <Box sx={{ m: 2 }}>
                          ...
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              checked={checkedTypes.includes(
                                row.attributes.type_name
                              )}
                              onChange={(event) => {
                                handleChangeChkTypes(
                                  event,
                                  row.attributes.type_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.type_name}
                            >
                              <span>
                ...
                {subTires_brand_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <Divider orientation="horizontal">{t('Common:tires')}</Divider>
                      <Accordion defaultExpanded>
                        <AccordionSummary>
                          <ThemeProvider theme={font}>
                            <Typography
                          ...
                          {tireBrand.map((row: any, index: any) => (
                            <div className="checkbox-wrapper-4" key={index}>
                              <input
                                ...
                                type="checkbox"
                                checked={checkedTireBrands.includes(
                                  row.attributes.brand_name
                                )}
                                onChange={(event) => {
                                  handleChangeChkTireBrands(
                                    event,
                                    row.attributes.brand_name
                                  );
                                }}
                              ...
                              <label
                                className="cbx"
                                htmlFor={row.attributes.brand_name}
                              >
                                <span>
                                  <svg width="12px" height="10px"></svg>
                                </span>
                        ...
                        {tireDiameter.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedTireDiameter.includes(
                                row.attributes.diameter_name
                              )}
                              onChange={(event) => {
                                handleChangeChkTireDiameter(
                                  event,
                                  row.attributes.diameter_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.diameter_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                        ...
                        {tireWidth.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedTireWidth.includes(
                                row.attributes.width_name
                              )}
                              onChange={(event) => {
                                handleChangeChkTireWidth(
                                  event,
                                  row.attributes.width_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.width_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                        ...
                        {tireRatio.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedTireRatio.includes(
                                row.attributes.ratio_name
                              )}
                              onChange={(event) => {
                                handleChangeChkTireRatio(
                                  event,
                                  row.attributes.ratio_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.ratio_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                ...
                {subLubeOil_brand_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Divider orientation="horizontal">{t('Common:lube-oil')}</Divider>
                    <Accordion defaultExpanded>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography
                        ...
                        {lubeOil_Brand.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              id={row.attributes.brand_name}
                              type="checkbox"
                              checked={checkedLubeOilBrand.includes(
                                row.attributes.brand_name
                              )}
                              onChange={(event) => {
                                handleChangeChkLubeOil_Brand(
                                  event,
                                  row.attributes.brand_name
                                );
                              }}
                        ...
                        {lubeOil_fluid_type.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedLubeOilFluid_type.includes(
                                row.attributes.fluid_type_name
                              )}
                              onChange={(event) => {
                                handleChangeChkLubeOil_Fluid_type(
                                  event,
                                  row.attributes.fluid_type_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.fluid_type_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                ...
                {subLubeOil_engineOil_typesofengineoil_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Accordion defaultExpanded>
                      ...
                      <AccordionDetails>
                        {lubeOil_engineOil_typesofengineoil.map(
                          (row: any, index: any) => (
                            <div className="checkbox-wrapper-4" key={index}>
                              <input
                                className="inp-cbx"
                                ...
                                type="checkbox"
                                checked={checkedLubeOil_engineOil_typesofengineoil.includes(
                                  row.attributes.typesofengineoil_name
                                )}
                                onChange={(event) => {
                                  handleChangeChkLubeOil_engineOil_typesofengineoil(
                                    event,
                                    row.attributes.typesofengineoil_name
                                  );
                                }}
                              ...
                              <label
                                className="cbx"
                                htmlFor={row.attributes.typesofengineoil_name}
                              >
                                <span>
                                  <svg width="12px" height="10px"></svg>
                                </span>
                ...
                {subShockAbsorber_brand_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Divider orientation="horizontal">{t('Common:shock-absorber')}</Divider>
                    <Accordion defaultExpanded>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography
                        ...
                        {shockAbsorber_Brand.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              id={row.attributes.brand_name}
                              type="checkbox"
                              checked={checkedShockAbsorberBrands.includes(
                                row.attributes.brand_name
                              )}
                              onChange={(event) => {
                                handleChangeChkShockAbsorberBrands(
                                  event,
                                  row.attributes.brand_name
                                );
                              }}
                          ...
                          (row: any, index: any) => (
                            <div className="checkbox-wrapper-4" key={index}>
                              <input
                                ...
                                type="checkbox"
                                checked={checkedShockAbsorberShockuptype.includes(
                                  row.attributes.shockuptype_name
                                )}
                                onChange={(event) => {
                                  handleChangeChkShockAbsorberShockuptype(
                                    event,
                                    row.attributes.shockuptype_name
                                  );
                                }}
                              ...
                              <label
                                className="cbx"
                                htmlFor={row.attributes.shockuptype_name}
                              >
                                <span>
                                  <svg width="12px" height="10px"></svg>
                                </span>
                ...
                {subBrake_brand_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Divider orientation="horizontal">{t('Common:brakes')}</Divider>
                    <Accordion defaultExpanded>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography
                        ...
                        {brake_brands.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              id={row.attributes.brand_name}
                              type="checkbox"
                              checked={checkedBrakeBrands.includes(
                                row.attributes.brand_name
                              )}
                              onChange={(event) => {
                                handleChangeChkBrakeBrands(
                                  event,
                                  row.attributes.brand_name
                                );
                              }}
                        ...
                        {brake_braketype.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedBrakeBraketype.includes(
                                row.attributes.braketype_name
                              )}
                              onChange={(event) => {
                                handleChangeChkBrakeBraketype(
                                  event,
                                  row.attributes.braketype_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.braketype_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                ...
                {subBattery_brand_fIlter ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Divider orientation="horizontal">{t('Common:battery')}</Divider>
                    <Accordion defaultExpanded>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography
                        ...
                        {battery_brands.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              id={row.attributes.brand_name}
                              type="checkbox"
                              checked={checkedBatteryBrands.includes(
                                row.attributes.brand_name
                              )}
                              onChange={(event) => {
                                handleChangeChkBatteryBrands(
                                  event,
                                  row.attributes.brand_name
                                );
                              }}
                        ...
                        {battery_amp.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              type="checkbox"
                              checked={checkedBatteryAmp.includes(
                                row.attributes.amp_name
                              )}
                              onChange={(event) => {
                                handleChangeChkBatteryAmp(
                                  event,
                                  row.attributes.amp_name
                                );
                              }}
                            ...
                            <label
                              className="cbx"
                              htmlFor={row.attributes.amp_name}
                            >
                              <span>
                                <svg width="12px" height="10px"></svg>
                              </span>
                ...
                {subOtherproduct_brands ? (
                  <AccordionGroup disableDivider sx={{ maxWidth: "auto" }}>
                    <Divider orientation="horizontal">{t('Common:other-product')}</Divider>
                    <Accordion defaultExpanded>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography
                        ...
                        {otherproduct_brands.map((row: any, index: any) => (
                          <div className="checkbox-wrapper-4" key={index}>
                            <input
                              ...
                              id={row.attributes.brand_name}
                              type="checkbox"
                              checked={checkedOtherproduct_brands.includes(
                                row.attributes.brand_name
                              )}
                              onChange={(event) => {
                                handleChangeChkOtherproduct_brands(
                                  event,
                                  row.attributes.brand_name
                                );
                              }}
