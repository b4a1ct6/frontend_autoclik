                        ...
                        >
                            ...
                            >
                              ...
                              >
                                {row.attributes?.blog_categories.data[0]?.attributes.catagory_name
                                  .replace(/_/g, " ")
                                  .toUpperCase()}
                                {row.attributes?.blog_categories.data[1] &&
                                  ", "}
                              </Typography>
                            </Link>
                            ...
                            >
                              ...
                              >
                                {row.attributes?.blog_categories.data[1]?.attributes.catagory_name
                                  .replace(/_/g, " ")
                                  .toUpperCase()}
                                {row.attributes?.blog_categories.data[2] &&
                                  ", "}
                              </Typography>
                            </Link>
                            ...
                            >
                              ...
                              >
                                {row.attributes?.blog_categories.data[2]?.attributes.catagory_name
                                  .replace(/_/g, " ")
                                  .toUpperCase()}
                                {row.attributes?.blog_categories.data[3] &&
                                  ", "}
                              </Typography>
                            </Link>
                          </Grid>
                          ...
                          >
                            ...
                            >
                              ...
                              {getYear(row.attributes?.blog_posted_date)}{" "}
                        ...
                        >
                          ...
                          >
                            <Markdown rehypePlugins={[rehypeRaw]}>
                              {truncateWords(row.attributes?.blog_detail, 20)}
                            </Markdown>
                          </Typography>
                        </motion.div>
                      </Grid>
