                ...
                >
                  {join_usData.map((row: any, index: any) => (
                    <Accordion key={index}>
                      <AccordionSummary>
                        <ThemeProvider theme={font}>
                          <Typography sx={{ fontSize: isDesktop?"18px":'16px', color: "black" }}>
                            {row.attributes.joinus_title}
                          </Typography>
                        </ThemeProvider>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Grid item xs={12} sx={{ p: isDesktop?2:0 }}>
                          <ThemeProvider theme={font}>
                            <Typography
                              sx={{ fontSize: isDesktop?"17px":'15px', color: "black" }}
                              component={"div"}
                            >
                ...
                <Grid container>
                  <ThemeProvider theme={font}>
                    ...
                    >
                      ...
                      >
                        &nbsp;1111 Village No.1 Maliwan Road, Bantum
                        Sub-District, Muang District, Khonkaen, 40000
                      </Typography>
                    </Grid>
                    <Grid
                      item
                    ...
                    >
                      ...
                      >
                        &nbsp;062-6806866, 095-179-9039, 063-021-5333,
                        043-306-333 ต่อ 3
                      </Typography>
                    </Grid>
                    <Grid
