      ...
      <CssBaseline>
        <Background>
          <Grid container sx={{ justifyContent: "center", display: "flex" }}>
            <Grid item xs={isDesktop?8:11} sx={{ bgcolor: "", height: "", mb:5}}>
                  ...
                  <Grid container sx={{ mt: 3 }}>
                    ...
                    >
                      <ThemeProvider theme={font}>
                        ...
                        >
                          <Link
                            href={`${locationData.attributes?.location_map}`}
                          >
                            <Button
                              sx={{
                                borderRadius: "10px",
                  ...
                  <Grid item xs={isDesktop?3:12}>
                    ...
                    <Grid item xs={12} sx={{mt:2}}>
                        <Grid container>
                            ...
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                                <Link href={'https://www.facebook.com/autoclikfastfit/'} style={{textDecoration:'none'}}>
                            <Typography sx={{fontSize:'16px',fontWeight:'bold',color:'black',transition:'0.2s',":hover":{
                                color:'#f8981d'
                            }}}>
                            Autoclik
                                </Typography>
                        ...
                        <Grid container sx={{mt:2}}>
                            ...
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                            <Link href={'https://page.line.me/870xuwqi?openQrModal=true'} style={{textDecoration:'none'}}>
                            <Typography sx={{fontSize:'16px',fontWeight:'bold',color:'black',transition:'0.2s',":hover":{
                                color:'#f8981d'
                            }}}>
                            @Autoclik
                  ...
                  <Grid item xs={isDesktop?3:12}>
                    <ThemeProvider theme={font}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                                <Link href={'https://line.me/R/ti/p/%40356itzaj'} style={{textDecoration:'none'}}>
                            <Typography sx={{fontSize:'16px',fontWeight:'bold',color:'black',transition:'0.2s',":hover":{
                                color:'#f8981d'
                            }}}>
                ...
                <Divider />
                  ...
                  <Grid item xs={isDesktop?3:12}>
                    <ThemeProvider theme={font}>
                        ...
                        <Grid container>
                            <Grid item xs={2} sx={{justifyContent:'center',display:'flex'}}>
                            <LocalPhoneIcon sx={{fontSize:'30px',color:'#f8981d'}}/>
                            </Grid>
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                                <Link href={'https://www.facebook.com/autoclikfastfit/'} style={{textDecoration:'none'}}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                            <Typography sx={{fontSize:'16px',fontWeight:'',color:'black',transition:'0.2s'}}>
                        ...
                        <Grid container sx={{mt:2}}>
                            <Grid item xs={2} sx={{justifyContent:'center',display:'flex'}}>
                            <EmailIcon sx={{fontSize:'30px',color:'#f8981d'}}/>
                            </Grid>
                            <Grid item xs={10} sx={{justifyContent:'left',display:'flex',alignItems:'center'}}>
                            <ThemeProvider theme={font}>
                            <Typography sx={{fontSize:'16px',fontWeight:'bold',color:'black',transition:'0.2s',":hover":{
